...
BEGIN
    IF user_id IS NOT NULL AND EXISTS (SELECT * FROM doctor_users WHERE id = user_id) THEN
        ...
        WHERE id = user_id;
    ELSE
        -- Thêm người dùng mới nếu id không tồn tại hoặc là NULL
...
BEGIN
    IF patientId IS NOT NULL AND EXISTS (SELECT * FROM patients WHERE id = patientId) THEN
        -- Cập nhật thông tin bệnh nhân nếu id tồn tại
        UPDATE patients SET 
            doctorId = newDoctorId, 
        ...
        WHERE id = patientId;
    ELSE
        -- Thêm bệnh nhân mới nếu id không tồn tại hoặc là NULL
...
BEGIN
    ...
    IF EXISTS (SELECT * FROM places WHERE id = placeId) THEN
        ...
        UPDATE places SET name = placeName, createdAt = placeCreatedAt, updatedAt = placeUpdatedAt, deletedAt = placeDeletedAt WHERE id = placeId;
    ELSE
        -- Nếu id không tồn tại, chèn địa điểm mới
        INSERT INTO places (name, createdAt, updatedAt, deletedAt) VALUES (placeName, placeCreatedAt, placeUpdatedAt, placeDeletedAt);
    END IF;
END$$
...
BEGIN
    ...
    IF EXISTS (SELECT * FROM roles WHERE id = roleId) THEN
        ...
        UPDATE roles SET name = roleName, createdAt = roleCreatedAt, updatedAt = roleUpdatedAt, deletedAt = roleDeletedAt WHERE id = roleId;
    ELSE
        -- Nếu id không tồn tại, chèn vai trò mới
        INSERT INTO roles (name, createdAt, updatedAt, deletedAt) VALUES (roleName, roleCreatedAt, roleUpdatedAt, roleDeletedAt);
    END IF;
END$$
...
(1, 'SUCCESS', '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL),
(2, 'FAILED', '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL),
(3, 'PENDING', '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL),
(4, 'NEW', '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL),
(5, 'DONE', '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL);
...
(4, 'Doctor - Hary Pham', 'doctor10@gmail.com', '$2a$07$Bq0hCq3kVrvKUHfMT0NJROmQkx09aEQkGlwBGEdw799YJvWqH1kuy', 'LA', '088456735', 'doctor1.jpg', 'male', '   ', 2, 1, '2023-11-13 19:44:36', '2023-11-13 20:20:15', NULL),
...
(7, 'Doctor - Eric Pham', 'doctor3@gmail.com', '$2a$07$Bq0hCq3kVrvKUHfMT0NJROmQkx09aEQkGlwBGEdw799YJvWqH1kuy', 'LA', '088456735', 'doctor4.jpg', 'male', '      ', 2, 1, '2023-11-13 19:44:36', '2023-11-14 19:49:12', NULL),
(8, 'Supporter - Eric Pham', 'supporter@gmail.com', '$2a$07$Bq0hCq3kVrvKUHfMT0NJROmQkx09aEQkGlwBGEdw799YJvWqH1kuy', 'Arizona', '088456736', 'supporter.png', 'male', NULL, 3, 1, '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL),
(9, 'Supporter - Eric Pham 1', 'supporter1@gmail.com', '$2a$07$Bq0hCq3kVrvKUHfMT0NJROmQkx09aEQkGlwBGEdw799YJvWqH1kuy', 'Arizona', '088456736', 'supporter.png', 'male', NULL, 3, 1, '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL),
(10, 'Supporter - Eric Pham 2', 'supporter2@gmail.com', '$2a$07$Bq0hCq3kVrvKUHfMT0NJROmQkx09aEQkGlwBGEdw799YJvWqH1kuy', 'Arizona', '088456736', 'supporter.png', 'male', NULL, 3, 1, '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL),
(11, 'Supporter - Eric Pham 3', 'supporter3@gmail.com', '$2a$07$Bq0hCq3kVrvKUHfMT0NJROmQkx09aEQkGlwBGEdw799YJvWqH1kuy', 'Arizona', '088456736', 'supporter.png', 'male', NULL, 3, 1, '2023-11-13 19:44:36', '2023-11-13 19:44:36', NULL);
COMMIT;
